                ...
                <tbody>
                    ...
                    else
                    {
                        ...
                        <tr>
                            ...
                            <td>'.$row['email'].'</td>
                            <td>'.$row['phone'].'</td>
                            <td><a href="api/deleteMember.inc.php?mid='.$row['uniid'].'&classid='.$classN.'" type="button" class="btn btn-sm btn-outline-danger badge">Delete</a></td>
                        </tr>';
                        }
