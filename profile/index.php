            ...
            <div class="col-lg-4 col-xl-4">
                <div class="card-box text-center">
                    ...
                    <button type="button" class="btn btn-danger btn-xs waves-effect mb-2 waves-light"
                        data-toggle="modal" data-target="#exampleModal">Support</button>
                                ...
                                <table class="table table-borderless mb-0">
                                    ...
                                    assigment.due_date AS 'ass_due', assigment_members.ms_id AS 'userid' FROM assigment INNER JOIN assigment_members ON assigment_members.ms_id = '$id'";
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../class/showAssigment.php?id='.$row['ass_id'].'"><span class="badge badge-success">Open</span></a></td>
                                        </tr>';
                                            }
                                        }
                                        ?>
